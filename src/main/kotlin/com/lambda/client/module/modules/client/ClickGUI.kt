...
object ClickGUI : Module(
    ...
    val resizeBar by setting("Resize Bar", 2, 0..20, 1, unit = "px")
    ...
    val darkness by setting("Darkness", 0f, 0.0f..1.0f, 0.05f)
    val gridSize by setting("Snap Grid", 10.0f, 0.0f..50.0f, 1.0f, unit = "px")
    val fadeInTime by setting("Fade In Time", 0f, 0.0f..1.0f, 0.05f, unit = "s")
    val fadeOutTime by setting("Fade Out Time", 0f, 0.0f..1.0f, 0.05f, unit = "s")
